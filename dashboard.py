...
# open_overdue_tasks_per_space = dash_values.get_open_tasks_per_space()  # reporter.task_overdue_count_by_space()
# open_tasks_per_company = dash_values.get_task_count_by_company()  # reporter.task_count_by_company()
# open_overdue_tasks_per_company = dash_values.get_task_count_by_company()  # reporter.task_overdue_count_by_company()
# overdue_tasks_age = dash_values.get_tasks_age()  # reporter.overdue_tasks_by_age_and_space()
# tasks_age = dash_values.get_tasks_age()         #reporter.tasks_by_age_and_space()
#
...
# task_average_time_card = dash_cards.get_task_average_time_card(dash_values.get_tasks_age())
...
def change_page(page):
    ...
    return dash_cards.get_datatable_element()
...
def select_options(selected_company, selected_space, checked_overdue):
    ...
    if ctx.triggered:
        ...
        # filtered_grid = dash_values.get_grid_data()
